    <div class="container post">
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-0 post-body">
                ...
                <figure><img class="img-thumbnail" src="${images}/aboutImage.png">
                    <figcaption>Get the food you want, from the restaurants you love, delivered at Uber speed. </figcaption>
                </figure>
